...
DARK_GREEN: Tuple[int, int, int] = (0, 160, 0)
...
class Game:
    def __init__(self) -> None:
        ...
        self.images: list[str] = ["foto1.jpg", "foto2.jpg", "foto3.jpg"]
        self.running: bool = True
        self.score: int = 0
        self.map_image: pygame.Surface = self.load_image("mapa_polski.jpg", (400, 400))
    ...
    def draw_button(self, rect: Tuple[int, int, int, int], text:str, color: Tuple[int, int, int]=GREEN, hover_color: Tuple[int, int, int]=DARK_GREEN) -> bool:
    ...
    def draw_close_button(self) -> bool:
    ...
    def draw_text_center(self, text: str, y: int, font: pygame.font.Font=FONT) -> None:
